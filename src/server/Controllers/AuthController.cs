...
namespace TestVueDotNet.Server.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        private readonly TestVueDotNet.Server.Config serverConfig;
        private readonly Service.Config serviceConfig;
        private readonly ISignupService signupService;
        private readonly ITokenProviderService<Token> tokenService;

        public AuthController(IAntiforgery antiForgeryService, ILocalAuthenticationService authService, CultureService cultureService, IOptions<TestVueDotNet.Server.Config> serverConfig, IOptions<TestVueDotNet.Service.Config> serviceConfig, ISignupService signupService, ITokenProviderService<Token> tokenService, IDomainContextResolver resolver, ILocalizationService localization) : base(resolver, localization)
        {
