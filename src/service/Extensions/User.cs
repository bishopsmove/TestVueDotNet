...
namespace TestVueDotNet.Service
{
    public static partial class Extensions
    {
        ...
        {
            bool isVerified = roles.Any(o => o.RoleId == TestVueDotNet.Contract.Security.RoleTypes.Admin);  // admin users never have to go through account verification process
